 ...
 * Explanation:
 *									                                                  |  Byte  |  Byte  |    |  Byte  |  Byte  |
 * Line 24 - Since a signed int can hold values ranging from -32.767 .. +32.767 <=> 0b1000 0000 0000 0000 to 0111 1111 1111 1111, where presence of the most significant (i.e leftmost) bit shows if number is negative or not, 
